...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      ...
      description: 'Meteor-Collection个人博客',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'lxzhang666666/Meteor-Collection', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'lxzhang666666', // 必需
      link: 'https://github.com/lxzhang666666/Meteor-Collection', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://testingcf.jsdelivr.net/gh/lxzhang666666/img-bed@main/images/%E5%8D%9A%E4%B8%BB%E7%AE%80%E7%94%BB.jpg',
      name: 'Meteor',
      slogan: '吾必当乘此羽葆盖车',
    },
    ...
    social: {
      ...
      icons: [
        ...
        },
        {
          iconClass: 'icon-csdn',
          title: 'CSDN',
          link: 'https://blog.csdn.net/weixin_43748329',
        },
      ],
    },
